...
const en = {
  ...
  "pitaco.placeholder": "shout a pitacoâ¦ (Enter)",
  "err.pitaco.cooldown": "â One pitaco at a time â breathe.",
  "err.pitaco.full": "â The bezel is full of pitacos â wait a beat.",
...
const ptBR: Record<MessageKey, Message> = {
  ...
  "pitaco.placeholder": "solta um pitacoâ¦ (Enter)",
  "err.pitaco.cooldown": "â Um pitaco de cada vez â respira.",
  "err.pitaco.full": "â O mural tÃ¡ lotado de pitaco â espera um pouco.",
